...
namespace SchoolLibrary.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(IReaderManager readerManager, IUserManager userManager)
        {
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            if (ModelState.IsValid && WebSecurity.Login(model.UserName, model.Password, persistCookie: model.RememberMe))
            {
                ...
                if (Roles.IsUserInRole(model.UserName, "Librarian"))
                {
        ...
        {
            return View("AjaxLogin", new LoginModel());
        }
        ...
        public JsonResult AjaxLogin(LoginModel model)
        {
            if (ModelState.IsValid && WebSecurity.Login(model.UserName, model.Password, persistCookie: model.RememberMe))
            {
                if (Roles.IsUserInRole(model.UserName, "Admin") || Roles.IsUserInRole(model.UserName, "Librarian") || Roles.IsUserInRole(model.UserName, "Registered") || Roles.IsUserInRole(model.UserName, "Unregistered"))
                {
            ...
            return new JsonResult
                    {
                        Data = new { Success = false, ErrorMessage="Incorrect UserName or Password" },
        ...
        public ActionResult ExternalLoginConfirmation(RegisterExternalLoginModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                using (LibraryContext db = new LibraryContext())
                {
                    ...
                    var reader = this._readerManager.GetReaderByEmail(model.Email);
